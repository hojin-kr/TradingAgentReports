...
from cointradingagents.agents import *
from cointradingagents.agents.utils.agent_states import (
    AgentState,
    InvestDebateState,
    RiskDebateState,
)
from cointradingagents.agents.utils.memory import FinancialSituationMemory
from cointradingagents.dataflows.config import set_config
...
class CoinTradingAgentsGraph:
    ...
    def __init__(
        ...
        os.makedirs(self.config["coin_reports_dir"], exist_ok=True)
        os.makedirs(self.config["coin_eval_results_dir"], exist_ok=True)
